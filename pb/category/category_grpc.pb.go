...
const (
	CategoryService_FindCategoryById_FullMethodName = "/category.CategoryService/FindCategoryById"
)
...
type CategoryServiceClient interface {
	FindCategoryById(ctx context.Context, in *CategoryRequest, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) FindCategoryById(ctx context.Context, in *CategoryRequest, opts ...grpc.CallOption) (*Category, error) {
...
type CategoryServiceServer interface {
	FindCategoryById(context.Context, *CategoryRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) FindCategoryById(context.Context, *CategoryRequest) (*Category, error) {
...
func _CategoryService_FindCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).FindCategoryById(ctx, req.(*CategoryRequest))
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pb/category/category.proto",
}
